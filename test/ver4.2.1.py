...
form= f"If you think Korean is linguistically correct between the two texts, print out the word Korean, and if you think English is correct, print out English. Only one language must be printed out.\n\n Korean:{result_kor} English:{result_eng}"
print(form)
